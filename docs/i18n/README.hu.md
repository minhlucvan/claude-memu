...
Copyright (C) 2025 Alex Newman (@minhlucvan). Minden jog fenntartva.
...
- **Hibák**: [GitHub Issues](https://github.com/minhlucvan/claude-mem/issues)
- **Tároló**: [github.com/minhlucvan/claude-mem](https://github.com/minhlucvan/claude-mem)
- **Szerző**: Alex Newman ([@minhlucvan](https://github.com/minhlucvan))
