...
This `docs/public/` folder contains the **Mintlify documentation site** - the official user-facing documentation for claude-memu. It's a structured documentation platform with a specific file format and organization.
...
**For contributors working on claude-memu:**
