...
cat > ~/.claude-memu/settings.json << 'EOF'
{
  ...
  "CLAUDE_MEMU_OPENROUTER_API_KEY": "YOUR_OPENROUTER_API_KEY"
}
EOF
```
...
{
  "CLAUDE_MEMU_PROVIDER": "openrouter",
  "CLAUDE_MEMU_OPENROUTER_API_KEY": "your-key",
  "CLAUDE_MEMU_OPENROUTER_MODEL": "google/gemini-2.0-flash-exp:free"
}
```
...
{
  "CLAUDE_MEMU_PROVIDER": "openrouter",
  "CLAUDE_MEMU_OPENROUTER_API_KEY": "sk-or-..."
}
```
