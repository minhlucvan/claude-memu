...
cat > ~/.claude-memu/settings.json << 'EOF'
{
  "CLAUDE_MEMU_PROVIDER": "gemini",
  "CLAUDE_MEMU_GEMINI_API_KEY": "YOUR_GEMINI_API_KEY"
}
EOF
```
...
{
  "CLAUDE_MEMU_PROVIDER": "gemini",
  "CLAUDE_MEMU_GEMINI_API_KEY": "your-key",
  "CLAUDE_MEMU_GEMINI_MODEL": "gemini-2.5-flash"
}
```
...
{
  "CLAUDE_MEMU_PROVIDER": "gemini",
  "CLAUDE_MEMU_GEMINI_API_KEY": "AIza..."
}
```
