...
/**
 * Release script for claude-memu
...
async function publish() {
  try {
    console.log('📦 Claude-memu Marketplace Release Tool\n');
...
https://github.com/minhlucvan/claude-memu"`);
    ...
    console.log(`\n🏷️  Tag: https://github.com/minhlucvan/claude-memu/releases/tag/v${newVersion}`);
